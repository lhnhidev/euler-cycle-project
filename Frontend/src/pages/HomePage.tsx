...
const HomePage = () => {
  ...
  return (
    <>
      <div className="ml-[calc(var(--height-title-bar-windows)+10px)] mt-[var(--height-title-bar-windows)] grid h-[calc(100vh-var(--height-title-bar-windows))] grid-cols-[repeat(14,minmax(0,1fr))] grid-rows-[repeat(13,minmax(0,1fr))]">
        <div
